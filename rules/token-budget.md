...
- `docs-update` (`harnesses/claude/skills/docs-update/SKILL.md`) runs `wizard/scripts/scan-spec-freshness.sh` — free, deterministic — before ever dispatching `docs-updater` to spend judgment only on what the sweep actually flagged.
