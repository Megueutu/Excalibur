...
If an adapter starts explaining the process instead of pointing at it, it has grown too big: move the content back to `lib/pipeline/` if it's generic, or to the project's SDD destination if it's specific.
