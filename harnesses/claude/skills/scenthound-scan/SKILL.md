...
A thin wrapper over the `scenthound` subagent (`pipeline/agents/scenthound.md`). The caller doesn't need to know a full agent runs behind it — just that this command sniffs before a push and hands back a verdict.
