...
| "This is kind of obvious, I don't need to confirm" | Obvious to whom? If the task was classified as Feature/Big feature (see [entrypoint.md](../lib/pipeline/entrypoint.md)), the very fact that there's an open design decision is a sign "obvious" might not hold. |
