...
| "Isso é meio óbvio, não preciso confirmar" | Óbvio pra quem? Se a tarefa foi classificada como Feature/Big feature (ver [entrypoint.md](../pipeline/entrypoint.md)), o próprio fato de ter decisão de design em aberto já é sinal de que "óbvio" pode não ser. |
