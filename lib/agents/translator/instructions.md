...
| **Operational Excalibur** | **never** | the installed package (`node_modules/@spec/excalibur/`) entirely (rules, agent prompts, session directives), `pipeline/`, `rules/`, `tasks.yaml`, `history.yaml` — machinery an agent consumes |
