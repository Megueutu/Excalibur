...
Agents that carry it: `orchestrator`, `scribe`, `ideator`, `review`, `clerk`, `scenthound`. Agents that don't: `translator` and `prober`, neither of which makes a risky decision.
