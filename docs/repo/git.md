...
Commit rules for the Excalibur repository itself. Not to be confused with the git rules Excalibur *generates* for other projects (`onboarding/onboarding/github/`) — those are independent and chosen per project.
