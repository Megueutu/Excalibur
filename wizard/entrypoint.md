...
Invoke the `translator` subagent (see [`pipeline/agents/translator.md`](../pipeline/agents/translator.md)) against the destination's `Templates/` and `reflection/` folders, with the resolved language.
