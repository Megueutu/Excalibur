#!/usr/bin/env bash
# scripts/scaffold-obsidian-vault.sh — materializes a minimal .obsidian/
...
#
# Usage: scripts/scaffold-obsidian-vault.sh <sdd-destination-path>
...
if [[ -z "$DEST" ]]; then
  echo "Usage: scripts/scaffold-obsidian-vault.sh <sdd-destination-path>" >&2
  exit 1
fi
