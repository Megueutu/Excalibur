...
| File | What it is |
|---|---|
| [`flow.md`](flow.md) | The flow the agent follows, step by step |
...
Either way, the agent keeps probing on top of the answers before running `init.sh` — that part is always conversational (see step 5 of [`flow.md`](flow.md)).
